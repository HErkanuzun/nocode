...
import sty from "./PlasmicProductCarousel.module.css"; // plasmic-import: IcGmonHhsP8c/css

import DotCircleOIcon from "./icons/PlasmicIcon__DotCircleO"; // plasmic-import: 0FFRs_yi9J85/icon
import CircleOIcon from "./icons/PlasmicIcon__CircleO"; // plasmic-import: ouhNYwLJPrFF/icon
    ...
    >
      ...
      >
        <DataCtxReader__>
          {$ctx => (
            <React.Fragment>
              <div className={classNames(projectcss.all, sty.freeBox__fVkZ3)}>
                <Stack__
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.freeBox___7TfNg, {
                    [sty.freeBoxslider_first___7TfNgEtF6V]: hasVariant(
                      $state,
                      "slider",
                      "first"
                    ),
                    [sty.freeBoxslider_second___7TfNgWmYhf]: hasVariant(
                      $state,
                      "slider",
                      "second"
                    ),
                    [sty.freeBoxslider_third___7TfNgrBjBb]: hasVariant(
                      $state,
                      "slider",
                      "third"
                    )
                ...
                >
                  ...
                  <ProductTextField
                    className={classNames(
                      "__wab_instance",
                      sty.productTextField__zy8Ym
                    )}
                    field={"description"}
                  />

                  <div
                    className={classNames(projectcss.all, sty.freeBox__iHLly)}
                  >
                    <div
                      className={classNames(projectcss.all, sty.freeBox__xAaiK)}
                    />
                  ...
                  <Stack__
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox___999Oe)}
                  >
                    <LinkButton
                      className={classNames(
                        "__wab_instance",
                        sty.linkButton__vSjz
                      )}
                      text={"\u2295 Add to cart"}
                      type={"solidOrange"}
                    />
                ...
                <div className={classNames(projectcss.all, sty.freeBox__ihMn)}>
                  <ProductMedia
              ...
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__qrOe4)}
              >
                <PlasmicIcon__
                  PlasmicIconType={
                    hasVariant($state, "slider", "third")
                  ...
                  className={classNames(projectcss.all, sty.svg__ddAyT, {
                    [sty.svgslider_second__ddAyTWmYhf]: hasVariant(
                      $state,
                      "slider",
                      "second"
                    ),
                    [sty.svgslider_third__ddAyTrBjBb]: hasVariant(
                      $state,
                      "slider",
                      "third"
                    )
                ...
                <PlasmicIcon__
                  ...
                  className={classNames(projectcss.all, sty.svg__otVsp, {
                    [sty.svgslider_first__otVspEtF6V]: hasVariant(
                      $state,
                      "slider",
                      "first"
                    ),
                    [sty.svgslider_second__otVspWmYhf]: hasVariant(
                      $state,
                      "slider",
                      "second"
                    ),
                    [sty.svgslider_third__otVspRBjBb]: hasVariant(
                      $state,
                      "slider",
                      "third"
                    )
                ...
                <PlasmicIcon__
                  ...
                  className={classNames(projectcss.all, sty.svg__np2Pt, {
                    [sty.svgslider_third__np2PtrBjBb]: hasVariant(
                      $state,
                      "slider",
                      "third"
                    )
