...
import sty from "./PlasmicMenuButton.module.css"; // plasmic-import: erAWiXWwvt_U/css

import BarsIcon from "./icons/PlasmicIcon__Bars"; // plasmic-import: xBPATbAXNPPm/icon
import TimesIcon from "./icons/PlasmicIcon__Times"; // plasmic-import: 26vpjmeQ66J-/icon
...
function PlasmicMenuButton__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      >
        <BarsIcon
          className={classNames(projectcss.all, sty.svg__l5OnK, {
            [sty.svgexpanded__l5OnKf0QRh]: hasVariant(
              $state,
              "expanded",
              "expanded"
            )
        ...
        <TimesIcon
          className={classNames(projectcss.all, sty.svg__md0TR, {
            [sty.svgexpanded__md0TRf0QRh]: hasVariant(
              $state,
              "expanded",
              "expanded"
            )
