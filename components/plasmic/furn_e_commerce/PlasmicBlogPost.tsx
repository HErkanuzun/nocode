...
import sty from "./PlasmicBlogPost.module.css"; // plasmic-import: rDFwK0iAltUr/css
...
function PlasmicBlogPost__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__re9L, {
          [sty.freeBoxlong__re9LcEluH]: hasVariant($state, "long", "long")
        })}
      >
        {renderPlasmicSlot({
          defaultContents: (
            <PlasmicImg__
              alt={""}
              className={classNames(sty.img__aZapf)}
              displayHeight={"auto"}
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__mcx7R, {
          [sty.freeBoxlong__mcx7RCEluH]: hasVariant($state, "long", "long")
        })}
      >
        {renderPlasmicSlot({
