...
import sty from "./PlasmicFeatureItem.module.css"; // plasmic-import: ESEDpH_5Cp1D/css
    ...
    >
      ...
      >
        <DataCtxReader__>
          {$ctx => (
            <React.Fragment>
              <div className={classNames(projectcss.all, sty.freeBox__rm7Wf)}>
                <div
                  className={classNames(projectcss.all, sty.freeBox___648Ed)}
                />

                <div className={classNames(projectcss.all, sty.freeBox__hf25Y)}>
                  <Stack__
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox__niKz8)}
                  >
                    <ProductTextField
                      className={classNames(
                        "__wab_instance",
                        sty.productTextField__it3Pc
                      )}
                      field={"name"}
                    />
                    ...
                    <ProductTextField
                      className={classNames(
                        "__wab_instance",
                        sty.productTextField__jkLJ
                      )}
                      field={"description"}
                    />

                    <div
                      className={classNames(projectcss.all, sty.freeBox__eaNpA)}
                    >
                      <div
                    ...
                    <Stack__
                      as={"div"}
                      hasGap={true}
                      className={classNames(projectcss.all, sty.freeBox__pPLeP)}
                    >
                      <LinkButton
